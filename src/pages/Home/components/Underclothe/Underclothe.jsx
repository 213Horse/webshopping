...
const Underclothe = () => {
  return (
    <div className="underclothe-container">
      <div className="underclothe-title">
        <p className="text-[25px]">Đồ lót</p>
        <p className="text-[36px]">Chuyên dụng</p>
      </div>
